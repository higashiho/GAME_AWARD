...
namespace Player
{
    public class PlayerManager : IActor
    {
        ...
        public async void Initialization()
        {
            ...
            // 取得するまで待つ
            DataHandle = Addressables.LoadAssetAsync<GameObject>(Data.AdressKey);
            await DataHandle.Task;

            // 生成座標を設定   
            PlayerInstancePos InstancePos = new PlayerInstancePos(Data.PlayerCreatePos);
            ...
            PlayerNumber = new PlayerNumber(Data.Number);

            PlayerMove = new PlayerMove(Data, 
                                        rayRadiuse);
